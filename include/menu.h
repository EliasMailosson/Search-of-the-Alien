...
enum MenuPanels {PANEL_START, PANEL_GAMESELECTION, PANEL_SOCIAL, PANEL_OPTIONS,PANEL_FRIENDS,PANEL_ADDFRIEND, PANEL_MYUSERNAME, PANEL_PLANET_SELECT, PANEL_PLAYER_SELECT};
...
void updateMenu(Menu *pMenu, ClientControl *pControl, Client aClient, Sound aSound);
